...
func (it IntegrationsHandler) handleSlackIntegrtation(integrationType string, body models.CreateIntegrationSchema) (map[string]string, map[string]bool, int, error) {
