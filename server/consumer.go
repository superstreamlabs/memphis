...
func (o *consumer) getNextMsg() (*jsPubMsg, uint64, bool, error) { // *** bool (redelivery) returned value added by memphis
	...
	if len(o.subjf) == 0 {
		...
		return pmsg, 1, redelivery, err // ** redelivery added by memphis
	}
	...
	if filter.pmsg != nil {
		...
		filter.pmsg = nil
		return returned, 1, redelivery, err
	}
	if err == ErrStoreEOF {
	...
	return nil, 0, redelivery, err // ** redelivery added by memphis
}
